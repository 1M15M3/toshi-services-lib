...
from toshi.web import Application
...
from toshi.test.analytics import MockMixpanel

logging.basicConfig()

class ToshiWebSocketJsonRPCClient:
    ...
    async def connect(self):
        ...
        headers = {'User-Agent': 'Toshi-Test-Websocket-Client'}
        if self.signing_key:
